...
OOP.mixClass(TDPairEnum, TDBase);

TDPairEnum.prototype.attachView = function () {
    this.elt.clearChild();
    this.$text = _({
        tag: 'span', child: {text: ''}
    });
...
TDPairEnum.prototype.loadDescriptor = function () {
...
TDPairEnum.prototype.implicit = function (value) {
...
TDBase.typeClasses.enum = TDPairEnum;
TDBase.typeClasses.ComboBox = TDPairEnum;
export default TDPairEnum;